...
<footer class="site-footer footer-gray-1">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-6 text-left "> Hakcipta © Terpelihara Pejabat Setiausaha Kerajaan Negeri Kelantan {{ now()->year }} </div>
          <div class="col-md-6 col-sm-6 text-right "> 
            <div class="widget-link "> 
              <ul>
                 <li><a href="{{ url('dasar-keselamatan-dan-privasi') }}">  Dasar Keselamatan & Privasi</a></li> 
              </ul>
            </div>
          </div>
        </div>
