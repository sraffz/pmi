<header class="site-header mo-left navstyle5 header">
    <div class="top-bar">
        <div class="container">
            <div class="row d-flex justify-content-between align-items-center">
                <div class="dlab-topbar-left">
                    <ul>
                        <li><i class="la la-phone-volume text-white"></i> +60 9 7485 826</li>
                        <li><i class="las la-map-marker text-white"></i> Pejabat Setiausaha Kerajaan Negeri Kelantan</li>
                    </ul>
                </div>
                <div class="dlab-topbar-right">
                    <ul>
                        <li><i class="la la-clock text-white"></i> Ahad - Rabu 8.00 - 17.00, Khamis 8.00 - 15.30</li>
                        <li><i class="las la-envelope-open text-white"></i> bpsm@kelantan.gov.my</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="main-bar clearfix ">
            <div class="container clearfix">
                ...
                <div class="logo-header mostion logo-dark">
                    <a href="{{ url('/') }}"><img src="{{ asset('images/e-PMI-logo.png') }}"
                            alt=""></a>
                </div>
                <!-- nav toggle button -->
