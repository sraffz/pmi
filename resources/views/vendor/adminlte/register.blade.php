        ...
        <div class="register-logo">
            <span class="db">
                <div class="container-fluid">
                    <a href="{{ url('/') }}"><img src="{{ asset('images/suk.png') }}" width="100px" alt="logo"></a>
                    <br>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div
                                class="form-group has-feedback {{ $errors->has('no_kad_pengenalan') ? 'has-error' : '' }}">
                                <input type="text" name="no_kad_pengenalan" class="form-control"
                            ...
                            <div class="form-group has-feedback {{ $errors->has('password') ? 'has-error' : '' }}">
                                <div class="input-group">
                                    <input type="password" class="form-control" id="password" name="password"
                                        autocomplete="off" placeholder="{{ trans('adminlte::adminlte.password') }}"
                                        data-toggle="tooltip"
                                        title="Katalaluan mesti mempunyai sekurangnya 12 aksara, 1 nombor, 1 huruf besar dan kecil serta 1 simbol">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group has-feedback {{ $errors->has('skim') ? 'has-error' : '' }}">
                                ...
                                <select name="skim" class="form-control select2" value="{{ old('skim') }}" required>
                                    <option value="">Jawatan</option>
                                    @foreach ($skim as $skims)
                                        <option value="{{ $skims->skim }}" @if (old('skim') == $skims->skim) selected @endif>{{ $skims->skim }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('skim'))
                                    <span class="help-block">
                                    ...
                                    <div class="form-group has-feedback {{ $errors->has('gred_kod') ? 'has-error' : '' }}">
                                        <select name="gred_kod" class="form-control select2" value="{{ old('gred_kod') }}" required>
                                            ...
                                            @foreach ($gred_kod as $gk)
                                                <option value="{{ $gk->gred_kod_abjad }}" @if (old('gred_kod') == $gk->gred_kod_abjad) selected @endif>{{ $gk->gred_kod_abjad }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group has-feedback {{ $errors->has('gred') ? 'has-error' : '' }}">
                                        <select name="gred" class="form-control select2" value="{{ old('gred') }}" required>
                                            ...
                                            @foreach ($gred_angka as $ga)
                                                <option value="{{ $ga->gred_angka_nombor }}" @if (old('gred') == $ga->gred_angka_nombor) selected @endif>
                            ...
                            <div class="form-group has-feedback {{ $errors->has('jabatan') ? 'has-error' : '' }}">
                                <select name="jabatan" class="form-control select2" value="{{ old('jabatan') }}" required>
                                    <option value="">Jabatan</option>
                                    @foreach ($jabatan as $jabatans)
                                        <option value="{{ $jabatans->jabatan_id }}" @if (old('jabatan') == $jabatans->jabatan_id) selected @endif>
                            ...
                            <div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}">
                                <input type="email" name="email" class="form-control" value="{{ old('email') }}"
                                    autocomplete="off" placeholder="{{ trans('adminlte::adminlte.email') }}">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group has-feedback {{ $errors->has('captcha') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="captcha" name="captcha" autocomplete="off"
                                    class="form-control" placeholder="{{ trans('adminlte::adminlte.captcha') }}">
