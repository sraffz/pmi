    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="logo">
                ...
                <span class="logo-mini"><img src="{{ asset('images/e-PMI-logo.png') }}" alt=""></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><img src="{{ asset('images/e-PMI-logo.png') }}" alt=""></span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                <div class="user-panel">
                    ...
                    <img src="{{ asset('/images/suk-small.png') }}" class="img-circle" alt="User Image" width="45">
                    </div>
                    <div class="pull-left info">
                        <br>
                      <p>{{ ucfirst(Auth()->user()->nama_singkatan) }}</p>
                    </div>
                  </div>
                <!-- Sidebar Menu -->
                <ul class="sidebar-menu" data-widget="tree">
                <li class="header" style="text-align: center;">
                    <font color="pink">MENU {{ strtoupper(Auth()->user()->peranan->pluck('display_name')->first())  }}</font></li>
